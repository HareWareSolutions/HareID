...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.CreateCheckoutRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User Credentials (only GoogleSub needed)",
                        "name": "credentials",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        "controllers.CreateCheckoutRequest": {
            "type": "object",
            "properties": {
                "cancel_url": {
                    "type": "string"
        ...
        "models.TeamMember": {
            ...
            "properties": {
                ...
                "role": {
                    "$ref": "#/definitions/enums.TeamRole"
                },
                "team_id": {
                    "type": "integer"
                },
        ...
        "models.User": {
            ...
            "properties": {
                "auth_provider": {
                    "$ref": "#/definitions/enums.AuthProvider"
                },
                "consent_terms": {
                    "type": "boolean"
                },
                ...
                "stripe_customer_id": {
                    "description": "Provedor Autenticação - Google - Senha",
                    "type": "string"
                },
                "update_date": {
                    "type": "string"
